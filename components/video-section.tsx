...
const videoItems: VideoItem[] = [
  {
    ...
    videoUrl: "https://example.com/videos/honey-glazed-donuts.mp4",
    duration: "1:45",
    featured: true,
    type: "video",
  },
  {
    ...
    thumbnail: "/placeholder.svg?height=600&width=800",
    videoUrl: "https://example.com/videos/queen-bee-cake.mp4",
    duration: "2:30",
    featured: true,
    type: "video",
  },
  {
    ...
    thumbnail: "/images/tiktok-thumbnail.png",
    videoUrl: "",
    duration: "0:30",
    featured: true,
    type: "tiktok",
  ...
  },
  {
    ...
    thumbnail: "/placeholder.svg?height=600&width=800",
    videoUrl: "https://example.com/videos/honeycomb-technique.mp4",
    duration: "3:20",
    type: "video",
  },
  {
    ...
    thumbnail: "/placeholder.svg?height=600&width=800",
    videoUrl: "https://example.com/videos/our-story.mp4",
    duration: "4:15",
    featured: true,
    type: "video",
  },
  {
    ...
    thumbnail: "/placeholder.svg?height=600&width=800",
    videoUrl: "https://example.com/videos/honey-harvest.mp4",
    duration: "2:10",
    type: "video",
  },
]
