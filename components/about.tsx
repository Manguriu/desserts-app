...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="py-12 md:py-16 lg:py-24 bg-blue-50 dark:bg-blue-950/30"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="space-y-3 md:space-y-4 text-gray-600 dark:text-gray-300 text-sm sm:text-base">
              <p>
                Sweet Treats began with a simple passion for creating delicious
                desserts that bring joy to people's lives. Founded in 2015 by
                pastry chef Emma Johnson, our little shop has grown into a
                beloved destination for dessert lovers.
              </p>
              <p>
                We believe that the best desserts are made with high-quality
                ingredients, creativity, and a whole lot of love. Every cake,
                yogurt parfait, ice cream scoop, and coffee drink is crafted
                with attention to detail and a commitment to excellence.
              </p>
              <p className="hidden md:block">
                Our team of talented pastry chefs and baristas work tirelessly
                to create new and exciting flavors while perfecting the
                classics. We source our ingredients locally whenever possible
